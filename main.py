# Set board as a list
# where each index 1-9 corresponds with a number on a number pad a 3 by 3 board representation.
...
# to take in a player input and assign their marker as 'X' or 'O'.
...
#  take in the board list ,a marker ('X' or 'O')
